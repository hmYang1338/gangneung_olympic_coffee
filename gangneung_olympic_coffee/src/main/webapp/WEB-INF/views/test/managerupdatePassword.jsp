...
<body>
	...
	<form action='<c:url value="updatePassword.do"/>' method="post" id="updatePassword" name="updatePassword">
		...
		현재 비밀번호 : <input type="password" name="now_password" id="now_password" maxlength="16"/><br>
		변경 비밀번호 : <input type="password" name="ch_password" id="ch_password" maxlength="16" onchange="compare()"/><br>
		변경 비밀번호 확인 : <input type="password" name="ch_password_ck" id="ch_password_ck" maxlength="16" onchange="compare()"/><br> 
		<div id="alert"></div>
		<input type="submit" value="비밀번호 변경" onclick="shin1();">
	</form>
</body>
</html>
