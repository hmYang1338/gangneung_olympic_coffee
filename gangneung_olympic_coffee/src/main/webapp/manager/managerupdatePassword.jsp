	...
	<div class="container col-centered text-center">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 brown-background">
			...
			<form class="form-group brown" action='<c:url value="updatePassword.do"/>' method="post" id="updatePassword" name="updatePassword" >
				...
				현재 비밀번호 : <input class="form-control input-lg brown" type="password" name="now_password" id="now_password" maxlength="16"/><br> 
				변경 비밀번호 : <input class="form-control input-lg brown" type="password" name="ch_password" id="ch_password" maxlength="16" onchange="compare()" /><br> 
				비밀번호 확인 : <input class="form-control input-lg brown" type="password" name="ch_password_ck" id="ch_password_ck" maxlength="16" onchange="compare()" /><br>
				<div id="alert"></div>
